      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl sm:text-2xl text-muted-foreground mb-2 max-w-3xl mx-auto">
            ...
            <br />
            <span className="text-primary font-semibold">A Streamlit-inspired framework for Java developers.</span>
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16 animate-slide-in">
          ...
          <div className="text-center p-6 rounded-lg bg-card shadow-soft hover:shadow-glow transition-all duration-300">
            ...
            <p className="text-muted-foreground">Leverage the power, ecosystem and familiarity of Java</p>
          </div>
          
          <div className="text-center p-6 rounded-lg bg-card shadow-soft hover:shadow-glow transition-all duration-300">
            <div className="text-3xl mb-4">🧠</div>
            <h3 className="text-lg font-semibold mb-2">Interactive</h3>
            <p className="text-muted-foreground">No event handling, no boilerplate. The simplest reactive model ever, inspired by streamlit.</p>
          </div>
        </div>
      </div>
    </section>
